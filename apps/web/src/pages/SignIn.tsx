            ...
            <div className="w-full max-w-md bg-white/10 p-8 rounded-3xl shadow-2xl backdrop-blur-xl space-y-8 relative z-10 border border-white/20">
                ...
                >
                    <div className="text-center">
                        ...
                        <p className="mt-2 text-white/80">Ready to continue your journey?</p>
                    </div>
                    ...
                    <p className="text-center text-sm text-white/80">
                        ...
                        <Link to="/signup" className="text-white hover:text-white font-medium underline decoration-2 underline-offset-4 hover:decoration-white/50 transition-all duration-200">
                            Sign up
                        </Link>
                    </p>
                </motion.div>
